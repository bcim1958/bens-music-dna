(function(){
  ...
  function readLearning(){return safeParse(window.localStorage.getItem(LEARNING_KEY),{version:4,signals:{},updatedAt:null});}
  ...
  function upsertSignal(id,rating,ratedAt){
    ...
    var model=readLearning();if(!model.signals)model.signals={};model.version=4;
  ...
  window.MUSIC_DNA_LEARNING={version:4,weights:WEIGHTS,storageKey:LEARNING_KEY,legacyKeys:LEGACY_KEYS.slice(),productionKeyPattern:PROD_RE,read:readLearning};
})();